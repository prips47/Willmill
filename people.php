                ...
                <div class="table-responsive">
                    <table class="table table-bordered" width="600px">
                        ...
                        <th colspan="3">
                            ...
                            <div style="font-size:16px;color:#626567 ;float: left;margin-left: 20px;">People you may know</div>
                            <a type="button" href="requests.php" style="float:right;margin-right: 20px;">Friend Requests</a></div>
                        </th>
                            <?php 
...
$select_query="select suggestion_id from suggestion where profile_id=$profile_id";
...
{
    $n=$x-1;
$select_query2="select suggestion_id,mutual_connections from suggestion where profile_id=$profile_id  ORDER BY mutual_connections DESC Limit $n" ;
...
{
    $select_query2="select suggestion_id,mutual_connections from suggestion where profile_id=$profile_id ORDER BY mutual_connections DESC";
    $select_query2_result= mysqli_query($con, $select_query2)
        or die(mysqli_error($select_query2_result));
}
...
$mutuals=$row['mutual_connections'];

$db2=mysqli_select_db($con,"newsfeed")
        or die(mysqli_error($con));

$select_query1="select first_name,last_name,profilepic,profession,place from users where id=$suggestion_id";
                        ...
                        <tr>
                                ...
                                <div class="connect">
                                    <form method="post" action="friend_request.php" >
                                        <input type="text" name="suggestion_id" value="<?php echo "$suggestion_id";?>" hidden>
                                        <input type="submit" class="btn-primary " value="Add Friend" name="add_friend" >
                                    </form>
                                </div>
                                </td>
  <?php }elseif ($i%3==2) 
